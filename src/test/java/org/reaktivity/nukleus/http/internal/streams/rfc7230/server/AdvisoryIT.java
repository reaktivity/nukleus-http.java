...
public class AdvisoryIT
{
    private final K3poRule k3po = new K3poRule()
            ...
            .addScriptRoot("client", "org/reaktivity/specification/http/rfc7230/advisory/")
            .addScriptRoot("server", "org/reaktivity/specification/nukleus/http/streams/rfc7230/advisory/");
